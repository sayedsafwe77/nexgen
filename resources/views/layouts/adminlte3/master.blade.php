            ...
            <ul class="navbar-nav ml-auto">
                @impersonating
                    <li class="nav-item dropdown">
                        <a class="nav-link d-flex align-items-center" href="{{ route('impersonate.leave') }}"
                            aria-expanded="true">
                    ...
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <li class="user-header bg-primary">
                            ...
                            <p>
                                ...
                                <small>@lang('users.since', [
                                    'date' => auth()->user()->created_at->diffForHumans(),
                                ])</small>
                            </p>
                        </li>
                        <!-- Menu Footer-->
                        <li class="user-footer">
                            <a href="{{ auth()->user()->dashboardProfile() }}"
                                class="btn btn-default btn-flat">@lang('users.profile')</a>
                            <a href="#"
