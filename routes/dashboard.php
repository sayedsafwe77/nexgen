...
Route::resource('feedback', 'FeedbackController')->only('index', 'show', 'destroy');
        ...
        Route::get('generate/input', 'ProductController@getInputForm')->name('products.generate.input');
        Route::post('products/{trashed_product}/restore', 'ProductController@restore')->name('products.restore');
        Route::post('products/add/input', 'ProductController@createInput')->name('products.add.input');
        Route::delete('products/{trashed_product}/forceDelete', 'ProductController@forceDelete')->name('products.forceDelete');
        Route::resource('products', 'ProductController');

        Route::get('trashed/qutations', 'QutationController@trashed')->name('qutations.trashed');
        Route::get('trashed/qutations/{trashed_qutation}', 'QutationController@showTrashed')->name('qutations.trashed.show');
        Route::post('qutations/{trashed_qutation}/restore', 'QutationController@restore')->name('qutations.restore');
        Route::delete('qutations/{trashed_qutation}/forceDelete', 'QutationController@forceDelete')->name('qutations.forceDelete');
        Route::resource('qutations', 'QutationController');
